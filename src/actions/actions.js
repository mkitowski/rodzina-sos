...
export function translateStartPage(content) {
  return async dispatch => {
    ...
    try {
      return dispatch(translateStartPageSuccess(content));
    } catch (error) {
      console.log(error);
...
export function translateTherapyPage(content) {
  return async dispatch => {
    ...
    try {
      return dispatch(translateTherapyPageSuccess(content));
    } catch (error) {
...
export function translateFertilityPage(content) {
  return async dispatch => {
    ...
    try {
      return dispatch(translateFertilityPageSuccess(content));
    } catch (error) {
...
export function translateAboutPage(content) {
  return async dispatch => {
    ...
    try {
      return dispatch(translateAboutPageSuccess(content));
    } catch (error) {
...
export function translateSection(content) {
  return async dispatch => {
    ...
    try {
      return dispatch(translateSectionSuccess(content));
    } catch (error) {
...
export function translateContactPage(content) {
  return async dispatch => {
    ...
    try {
      return dispatch(translateContactPageSuccess(content));
    } catch (error) {
